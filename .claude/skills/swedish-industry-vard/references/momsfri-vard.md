...
- **Medicinskt betingad fotvård** is equated with sjukvård (10 kap. 7 § 3 st). Ordinary pedicure is not.
...
- **Massör, hudterapeut, personlig tränare, kostrådgivare, akupunktör, osteopat, auktoriserad fotvårdsterapeut** are not on the list. Their services are taxable unless they also hold one of the 22 legitimations and act in that capacity.
...
| **Laser / IPL** | Treatment of a diagnosed skin disease, ärr or vascular malformation on medical indication by legitimerad personal | Permanent hårborttagning, hudföryngring, cellulitbehandling, pigment evening — the exact items HFD 2013 ref. 67 treated as outside the exemption |
...
| **Personlig träning, friskvård, rekreation** | Never exempt | Skatteverket lists *allmän rekreation och friskvård* as taxable in the vård context. The rate is then **not automatically 25 %**: Skatteverket's 2026 rate guidance puts **6 %** on *aktiviteter i form av idrott eller fysisk träning* incl. styrketräning, jazzdans, aerobics, workout och kampsporter, and on deltagaravgifter och entré till idrottsevenemang. A gym pass or a group class is 6 %; a PT hour sold as a personal service, and massage for wellbeing, are 25 %. Decide the rate per activity and see `swedish-vat` for the full rate table |
